...
//
//*****************************************************************************
extern void PinoutSet2(bool bEthernet, bool bUSB);
extern void LEDWrite2(uint32_t ui32LEDMask, uint32_t ui32LEDValue);
extern void LEDRead2(uint32_t *pui32LEDValue);
